  ...
  db.all(sql, (err, rows) => {
    if (err) {
      ...
      if (rows.length == 0) {
        ...
        res.redirect("https://express-tutorial3.glitch.me/protected_page");
      } else {
        res.render("signup", {
...
app.get("/logout", function(req, res) {
  ...
  res.redirect("https://express-tutorial3.glitch.me/login");
});
...
function checkSignIn(req, res, next) {
  if (req.session.user) {
    ...
    res.redirect("https://express-tutorial3.glitch.me/failed_attempt");
  }
}
